      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50 flex-shrink-0">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-gray-900">Select Purchase Unit</h3>
              <p className="text-xs text-gray-600">Choose quantity and unit type</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 h-full">
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-teal-50 p-3 rounded-lg border border-emerald-200">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-bold text-emerald-900 mb-2 text-sm">Product Information</h4>
                    <div className="grid grid-cols-2 gap-3 text-xs">
                      <div>
                        <span className="font-semibold text-emerald-800">Generic:</span>
                        <div className="text-emerald-700 font-medium">{product.generic_name || "Unknown"}</div>
                      </div>
                      {product.brand_name && (
                        <div>
                          <span className="font-semibold text-emerald-800">Brand:</span>
                          <div className="text-emerald-700 font-medium">{product.brand_name}</div>
                        </div>
                      )}
                      {product.dosage_strength && (
                        <div>
                          <span className="font-semibold text-emerald-800">Dosage:</span>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {hasVariants ? (
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-center space-y-2">
                            <div className={`mx-auto w-10 h-10 flex items-center justify-center rounded-lg transition-colors ${
                            ...
                            <div>
                              <h4 className={`font-bold text-sm ${isSelected ? "text-blue-700" : "text-gray-900"}`}>
                                {variant.name}
                              </h4>
                            ...
                            <div className="space-y-1">
                              ...
                              <div className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${
                                isAvailable
                                  ? variant.stock > 10 ? "bg-green-100 text-green-700" : "bg-yellow-100 text-yellow-700"
                    ...
                    <div className="col-span-full p-3 text-center bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg">
                      ...
                      <h3 className="text-xs font-semibold text-gray-800">No Options Available</h3>
                    </div>
                  )}
                </div>
              </div>
              ...
              {isCompletelyOutOfStock && (
                <div className="p-2 bg-red-50 border border-red-200 rounded-lg">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-sm font-bold text-red-800">Out of Stock</div>
                      <div className="text-xs text-red-600">No stock available</div>
                    </div>
                  </div>
                </div>
              )}
              ...
              {!isCompletelyOutOfStock && availableStockInPieces <= 20 && (
                <div className="p-2 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-sm font-bold text-yellow-800">Low Stock</div>
                      <div className="text-xs text-yellow-600">Only {availableStockInPieces} left</div>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="lg:col-span-1 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 border-l border-gray-200 flex flex-col">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h4 className="text-lg font-bold text-blue-900">Order Summary</h4>
              </div>
              ...
              {!isOutOfStock && (
                <div className="space-y-3 flex-1">
                  ...
                  <div className="bg-white rounded-lg p-3 border border-blue-200 shadow-sm">
                    <div className="space-y-3">
                      <div className="text-center">
                        <div className={`mx-auto w-12 h-12 flex items-center justify-center rounded-lg mb-2 ${
                          selectedVariant === "piece" ? "bg-blue-600 text-white" : 
                          selectedVariant === "sheet" ? "bg-purple-600 text-white" :
                        ...
                        <p className="text-xs text-gray-600">
                          {currentVariant?.description || "Choose purchase unit"}
                        </p>
                      </div>
                  ...
                  <div className="bg-white rounded-lg p-3 border border-blue-200">
                    <h6 className="font-semibold text-gray-900 mb-2 text-sm">Stock Info</h6>
                    <div className="space-y-1.5 text-xs">
                      <div className="flex justify-between">
                        <span className="text-gray-600">Available:</span>
                        <span className={`font-bold ${
                          availableStockInPieces > 20 ? "text-green-600" : 
                          availableStockInPieces > 0 ? "text-yellow-600" : "text-red-600"
                        }`}>
                      ...
                      {currentVariant && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Max {currentVariant.unit}:</span>
                          <span className="font-bold text-gray-900">
                            {maxQuantity}
                          </span>
                        </div>
              ...
              {isOutOfStock && (
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-center p-4">
                    ...
                    <h5 className="text-base font-bold text-red-800 mb-1">Unavailable</h5>
