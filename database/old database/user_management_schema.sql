-- Enhanced User Management Schema for MedCure-Pro
...
-- Additional indexes for login_attempts table
...
-- Create a default super admin user (modify as needed)
-- Note: This should be done after setting up authentication
/*
INSERT INTO user_profiles (id, email, first_name, last_name, status)
VALUES (
    'super-admin-uuid', -- Replace with actual UUID from auth.users
    'admin@medcure-pro.com',
    'System',
    'Administrator',
    'active'
...
VALUES (
    'super-admin-uuid', -- Replace with actual UUID
    'super_admin',
    'super-admin-uuid' -- Self-assigned
