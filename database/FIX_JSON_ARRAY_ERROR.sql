-- =================================================
-- 🚨 FIX JSON ARRAY PROCESSING ERROR
-- Handle empty arrays and improve error handling
-- =================================================
...
BEGIN
    ...
    BEGIN
        ...
        IF items_count > 0 THEN
            -- 4. Validate and insert new items
            ...
            LOOP
                ...
                IF product_name IS NULL THEN
                    RAISE NOTICE 'Product not found: %', item->>'product_id';
                    CONTINUE;
                END IF;
...
-- =================================================
-- ✅ JSON ARRAY PROCESSING FIX COMPLETE!
-- =================================================

SELECT 'JSON array processing fixed - now handles empty arrays!' as status;
